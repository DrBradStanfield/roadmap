...
- Cardiovascular disease (CVD) is one of the leading causes of premature, potentially preventable death in New Zealand.
...
Your doctor will determine whether cardiovascular risk assessment is appropriate for you based on your age, sex, and risk factors.

### CV Screening Age Ranges

| Group | Men | Women |
|---|---|---|
| Asymptomatic people without known risk factors | 45 to 74 years | 55 to 74 years |
| Māori, Pacific peoples, or Indo-Asian peoples | 30 to 74 years | 40 to 74 years |
| People with personal or family risk factors | 35 to 74 years | 45 to 74 years |
| People with severe mental illness | From age 25 years | From age 25 years |

**Indo-Asian patients** include: Indian (including Fijian Indian), Sri Lankan, Afghani, Bangladeshi, Nepalese, Pakistani, and Tibetan.

Your doctor will also record your smoking status, ethnicity, personal cardiovascular risk factors, and family history.
...
- Atrial fibrillation
- Established cardiovascular disease (heart attack, angina, TIA, stroke, peripheral vascular disease)
- Diabetes
- Genetic lipid disorder
- Heart failure
- Renal impairment (eGFR < 60, if aged under 75 years)
...
- Measure your sitting blood pressure (repeated if the first reading is elevated; the average of two seated readings is used for the CVRA)
- Take a non-fasting lipid profile and a non-fasting HbA1c to screen for diabetes
- If total cholesterol (TC) or TC:HDL ratio is greater than 8 mmol/L, the lipid test is repeated
- Fasting blood tests are only needed if triglycerides are elevated

### Blood Pressure Equivalence Points (Office vs Home/Ambulatory)

If you measure your blood pressure at home or with a 24-hour monitor, the readings differ slightly from clinic readings:

| Office (clinic) | Ambulatory or home |
|---|---|
| 130/80 | 125/75 |
| 140/90 | 135/85 |
| 160/100 | 150/96 |

### Calculating Your 5-Year CVD Risk

Your doctor will use the New Zealand CVD Prevention Equations (introduced 2018) to estimate your 5-year cardiovascular risk. These are built into practice management software and replace the older NZ modified Framingham equations.

---

## Very High Risk Group (Assumed > 15% 5-Year Risk)

Some patients are in a very high-risk group without needing a full risk calculation. Your doctor will still perform a CVRA to record the criteria. This group includes:

- Established heart failure
- eGFR < 30 mL/min/m²
- Asymptomatic carotid disease or asymptomatic coronary disease
...
### Under 30 Years With Known Risk Factors
...
Your doctor will use shared decision-making to discuss your risk category and what treatment makes sense for you:
...
- LDL cholesterol: below 1.4 mmol/L

### Moderate-Risk Patients (if medication is started)

- LDL-C reduction of at least 40%
- Office blood pressure below 130/80 mmHg

> **Note:** Non-fasting blood lipids are now recommended for all treatment decisions and monitoring, as long as triglyceride levels are normal. Fasting tests are only required if triglycerides are elevated.

---

## How Often Will I Need a Repeat Assessment?

| 5-year risk level | Recommended repeat interval |
|---|---|
| Less than 3% | Every 10 years |
| 3 to 9% | Every 5 years |
| 10 to 14% | Every 2 years |
...
- bpacnz: [What Your Lipid Test Means for You](https://bpac.org.nz/Supplement/2012/December/docs/bpac_2012_lipids_patient_info_A4.pdf)
- Healthify He Puna Waiora: [Statins](https://healthify.nz/medicines-a-z/s/statins)
- National Heart Foundation:
  - [Guide to Eating for a Healthy Heart](https://www.heartfoundation.org.nz/wellbeing/healthy-eating/eating-for-a-healthy-heart)
  - [Lowering Your Risk of Heart Attack and Stroke](https://assets.heartfoundation.org.nz/documents/shop/heart-healthcare/hf-lower-your-heart-attack-risk-2018.pdf)
  - [Managing Your Risk](https://www.heartfoundation.org.nz/wellbeing/managing-risk)
- [Omega-3 Fatty Acids and Cardiovascular Disease](https://aucklandregion.communityhealthpathways.org/patientinfo/Omega-3sAndCardiovascularDisease.pdf)
