...
Heart failure (HF) is the inability of the heart to pump sufficiently to meet the body's needs. It is a serious condition with an average annual mortality of 10%. Those with severe heart failure have an annual mortality of 30–50%.
...
- Māori men are about 4 times more likely, and Māori women about 4.5 times more likely, to be hospitalised with heart failure than non-Māori
- Heart failure occurs 10–15 years earlier in Māori patients
- Māori and Pacific patients younger than 50 are six times more likely to be hospitalised with heart failure than non-Māori

---

## Assessment

Your doctor will consider heart failure in newly breathless patients, particularly in Māori and other high-risk groups, and will look for the following signs and symptoms.
...
- Fatigue and increased time to recover after exercise
- Ankle swelling

**Less typical symptoms:**
- Nocturnal cough
- Wheezing
- Bloated feeling or loss of appetite
- Confusion (especially in older people)
- Depression
- Palpitations, dizziness, or fainting (syncope)
- Bendopnoea (breathlessness on bending forward)
- Chest pain

**Examination findings (more specific for heart failure):**
- Elevated jugular venous pressure (JVP)
- Hepatojugular reflux
- Third heart sound (gallop rhythm)
- Laterally displaced apical beat

**Other examination findings (less specific):**
- Weight gain of more than 2 kg per week, or weight loss in advanced heart failure
- Cardiac murmur
- Peripheral oedema (ankles, sacrum)
- Pulmonary crepitations (crackles at the lung bases)
- Reduced air entry and dullness at lung bases (pleural effusion)
- Tachycardia, irregular pulse, or tachypnoea
...
- Smoking, diabetes, high blood pressure, ischaemic heart disease
- Valvular heart disease
- Cardiomyopathies (e.g., alcohol-related, diabetic, hypertrophic, or genetic)
- Sleep apnoea, COPD, obesity
- Drug-related (e.g., previous cardiotoxic chemotherapy, methamphetamine)
- Chronic kidney disease
- Systemic illness (e.g., amyloidosis, sarcoidosis, haemochromatosis)
...
- Recreational stimulants (amphetamines, cocaine)

---

## Investigations

Your doctor will arrange tests. These may include:

### NT-proBNP (Brain Natriuretic Peptide)

NT-proBNP is a blood test useful for distinguishing heart failure from other causes of breathlessness. It is most useful as a rule-out test.

**Interpretation:**
- If NT-proBNP is **less than 35 pmol/L**, heart failure is unlikely
- **Suspect heart failure** if:
  - Younger than 50 years and NT-proBNP is greater than 67 pmol/L
...
- Full blood count, creatinine, electrolytes, albumin, liver function tests, HbA1c, lipids
- Thyroid function if clinically indicated (e.g., atrial fibrillation)
- Troponins if acute-onset symptoms and acute coronary syndrome is possible
- Iron studies if haemochromatosis or iron deficiency is suspected
...
Your doctor will grade your symptoms using the New York Heart Association (NYHA) classification to guide treatment decisions:
...
Heart failure is a complex condition. All medication decisions should be made by your doctor. This section explains the types of treatment that may be used and why.
...
- Increased coughing, particularly at night
...
- Lisinopril: starting 2.5 mg twice daily, target 20 mg twice daily
- Quinapril: starting 5 mg twice daily, target 20 mg twice daily
...
- Candesartan: starting 4 mg once daily, target 32 mg once daily
...
Beta-blockers improve survival, reduce hospitalisations, and improve heart function in HFrEF. They are only started once fluid overload is controlled (patient is euvolaemic).

**Examples and typical dosing:**
- Bisoprolol: starting 1.25 mg once daily, target 10 mg once daily
- Carvedilol: starting 3.125–6.25 mg twice daily, target 25 mg twice daily (50 mg twice daily if over 85 kg)
- Metoprolol succinate: starting 23.75 mg once daily, target 190 mg once daily
...
Diuretics are used to relieve fluid overload (congestion). They are used in HFrEF, HFmrEF, and HFpEF.

**Dosing:**
- Mild heart failure: furosemide 20 mg daily
...
- Low potassium (from diuretics) increases the risk of digoxin toxicity
- Drugs that can raise digoxin levels: amiodarone, diltiazem, verapamil, quinidine
...
Focus management on:
- **Underlying causes:** e.g., blood pressure control (ACEi, ARB, or MRA), atrial fibrillation management (beta-blocker)
- **Symptom relief:** loop diuretics for fluid overload, with close kidney function monitoring
