...
|---|---|---|---|---|---|---|
| product-health | [product-health/LOOP.md](product-health/LOOP.md) | `47 20 * * 0` (Mon 8:47am NZ) | `trig_01YTcwfc4Ko1F47W3Hc2qTeJ` | claude-fable-5 | Backlog items picked up by build sessions; funnel regressions caught first | active |
