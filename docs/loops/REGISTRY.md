...
| chat-health | [chat-health/LOOP.md](chat-health/LOOP.md) | `23 22 * * 0` (Mon 10:23am NZ) | `trig_01PhanDmZZWLpWJovnvfdLzm` | (session default) | Router match-rate improvement, measured before/after | active — charter compacted to fleet form 2026-08-10 (161 lines) |
