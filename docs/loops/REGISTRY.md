...
| chat-health | [chat-health/LOOP.md](chat-health/LOOP.md) | `23 22 * * 6` (Sun 10:23am NZ, 11:23 over NZ daylight saving) | `trig_01PhanDmZZWLpWJovnvfdLzm` | claude-fable-5 | Router match-rate improvement, measured before/after | active — charter compacted to fleet form 2026-08-10 |
