...
- Evidence: first live week (2026-W33, deployed 08-14): 17 typed enrolments vs 3 cloud rows all-time — the ~10:1 typed-lane bet held almost exactly; plan-ready CTR 40%. Week 2 (2026-W34): 35 typed enrolments (accelerating), plan-ready CTR 60% (21/35 clicked), 0 bounces, 0 complaints. Production rows with provider 'typed' + delivered emails now exist, though the deliberate end-to-end capture walk-through the Tests line calls for is still owed.
