...
6. ~~Clean up microvitamin.com embeds~~ **Reality (2026-08-07 live check): `microvitamin.com/pages/roadmap` 404s — the tool page is already gone on commerce** (which is *why* Clarity showed 0 sessions); `/pages/health-plan` carries only the site-chat embed. Remaining decision: redirect `/pages/roadmap` → drstanfield.com, or leave the 404.
