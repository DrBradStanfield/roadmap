...
An AI on your own machine skips our server entirely. It opens the file directly, so nothing about your record touches the internet. That is the option for anyone who does not want our server reading their record in memory, and it is the same tools and the same rules.
