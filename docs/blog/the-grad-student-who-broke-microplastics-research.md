...
keywords: ["blood pressure", "cardiovascular", "kidney", "obesity", "prostate"]
summary: "Dr Brad's microplastics post: three methodology problems (suspect math, glove contamination, fat mistaken for plastic) mean credit-card-per-week and plastic-in-brain headlines are not reliable. The chemicals with real evidence behind them are BPA, phthalates, and PFAS — measured in urine, linked to cardiovascular mortality, reproductive problems, and cancer."
---
