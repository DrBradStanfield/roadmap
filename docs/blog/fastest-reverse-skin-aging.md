...
This is not merely for vanity reasons. How our skin looks reflects our chances of living a long life. A 2012 review found that "_facial appearance and skin wrinkling at a sun-protected site reflect the propensity to reach an extreme old age and facial appearance reflects the risk of succumbing to CVD independently of chronological age, smoking, photodamage, and BMI"_ ([Source](https://academic.oup.com/biomedgerontology/article/68/2/145/544529)).

Here's a step-by-step guide to rejuvenate your skin quickly.

## Table of Contents

*   [Stopping the Damage](#table-of-contents-0)
*   [Retinoid Creams](#table-of-contents-1)
*   [Lactic Acid and Glycolic Acid](#table-of-contents-2)
*   [Supplements](#table-of-contents-3)
*   [Addressing Extrinsic Aging](#table-of-contents-4)
*   [Diet](#table-of-contents-5)
*   [Exercise](#table-of-contents-6)
*   [Sleep](#table-of-contents-7)
*   [Stress Management](#table-of-contents-8)
*   [Moisturizers with Ceramides](#table-of-contents-9)
*   [Sunscreen](#table-of-contents-10)
*   [Advanced Strategies](#table-of-contents-11)
*   [Conclusion](#table-of-contents-12)
*   [References](#table-of-contents-13)
...
Broadly speaking, there are two common types of retinoid creams: adapalene and tretinoin. Adapalene is the least irritating topical retinoid and is more targeted to the receptors in the skin, whereas tretinoin is an earlier version and generally causes more irritation to the skin ([Source](https://dermnetnz.org/topics/topical-retinoids)). But which type is better for skin aging?

In a head-to-head trial in 2018, both adapalene and tretinoin were equally effective at reversing the signs of skin aging ([Source](https://pubmed.ncbi.nlm.nih.gov/30105991/)). Since adapalene is less irritating and works just as well, it's probably the preferred version. In New Zealand, we don't have access to the higher strength 0.3% adapalene, so I use tretinoin 0.05% at night, but not every night. This brings us to the next cream I use.

## Lactic Acid and Glycolic Acid

Lactic acid and glycolic acid are exfoliants that, when used over the long term, affect the deeper layers of the skin and reduce wrinkles. Clinical guidelines note that these acids help collagen and elastin regenerate, making fine lines less obvious ([Source](https://dermnetnz.org/topics/alpha-hydroxy-acid-facial-treatments)).

Treatment with lactic acid, for example, has been shown to increase skin firmness, thickness, and improve smoothness and appearance of lines and wrinkles ([Source](https://pubmed.ncbi.nlm.nih.gov/8784274/)). Lactic acid and glycolic acid are known as alpha hydroxy acids. There's also beta hydroxy acids, such as salicylic acid. Both alpha and beta hydroxy acids help in the removal of dead skin cells and promote skin renewal.
...
A 2021 meta-analysis found what we already intuitively know: a lack of sleep accelerates the signs of skin aging ([Source](https://www.ncbi.nlm.nih.gov/pmc/articles/PMC8586245/)). Think of sleep as a nightly repair session for your skin.
...
The same was found for stress management. Stress, particularly financial stress, has been found to result in older perceived age, while the mechanistic and phenotypic effects of stress on the skin have been reviewed, and a possible link to older looks has been suggested ([Source](https://www.ncbi.nlm.nih.gov/pmc/articles/PMC8586245/)).
...
In 2019, a randomized controlled trial showed that ceramides significantly decreased wrinkles and improved skin texture ([Source](https://pubmed.ncbi.nlm.nih.gov/31585489/)).

## Sunscreen

The most important cream of all that I've mentioned so far, is sunscreen. It's crucial to pick a sunscreen with a certain ingredient in it. Before I get to that, here's a striking photo of a 92-year-old who used sunscreen on her face but not her neck ([Source](https://onlinelibrary.wiley.com/doi/full/10.1111/jdv.17660)).
...
In a landmark 2013 trial of 903 adults, the group who used sunscreen daily had no detectable increase in their skin aging after 4.5 years ([Source](https://pubmed.ncbi.nlm.nih.gov/23732711/)). A follow-up 2016 study showed a reversal of the signs of skin aging in the group who used sunscreen ([Source](https://pubmed.ncbi.nlm.nih.gov/27749441/)).
...
The American Academy of Dermatology concluded that the science doesn't show that any sunscreen ingredients currently available in the U.S. are harmful to human health ([Source](https://www.aad.org/media/stats-sunscreen)). Nevertheless, some people prefer to use mineral sunscreens such as Zinc Oxide, as those ingredients, while they don't offer as good UV protection, don't get absorbed.

There is, however, a chemical ingredient that offers the best of both worlds, called bemotrizinol. It offers fantastic UV protection, but it's a large molecule and doesn't get absorbed through the skin ([Source](https://dermnetnz.org/topics/allergy-to-bemotrizinol); [Source](https://cen.acs.org/business/consumer-products/Cloudy-outlook-sunscreen-ingredients-US/100/i42)). I apply the moisturizer first, wait a couple of minutes, then apply the sunscreen.
...
*   In perimenopausal women, hormone replacement may delay skin thinning. The skin is less dry, with fewer wrinkles, and wound healing is faster than prior to treatment ([Source](https://dermnetnz.org/topics/ageing-skin)).
...
1.  [Facial appearance and skin wrinkling at a sun-protected site reflect the propensity to reach an extreme old age](https://academic.oup.com/biomedgerontology/article/68/2/145/544529)
2.  [The term "retinoid" refers to the synthetic and natural analogues of vitamin A](https://www.ncbi.nlm.nih.gov/pmc/articles/PMC6791161/)
3.  [Topical 0.4% retinol lotion or its vehicle was applied at each visit by study personnel to either the right or the left arm up to 3 times a week for 24 weeks](https://pubmed.ncbi.nlm.nih.gov/17515510/)
4.  [Retinol lotion or a placebo lotion was applied to either the right or left arm](https://jamanetwork.com/journals/jamadermatology/fullarticle/412795)
5.  [Adapalene is the least irritating topical retinoid and tretinoin the most](https://dermnetnz.org/topics/topical-retinoids)
6.  [Adapalene 0.3% gel showed non-inferior efficacy to tretinoin 0.05% cream](https://pubmed.ncbi.nlm.nih.gov/30105991/)
7.  [Long-term use alpha hydroxy acids may also affect the deeper layers of the skin](https://dermnetnz.org/topics/alpha-hydroxy-acid-facial-treatments)
8.  [Treatment with 12% lactic acid resulted in increased epidermal and dermal firmness](https://pubmed.ncbi.nlm.nih.gov/8784274/)
9.  [Resistance training rejuvenates aging skin by reducing circulating inflammatory factors](https://www.ncbi.nlm.nih.gov/pmc/articles/PMC10290068/)
10.  [Defining skin aging and its risk factors](https://www.ncbi.nlm.nih.gov/pmc/articles/PMC8586245/)
11.  [Statistically significant decrease of hemoglobin index wrinkle and texture on the ceramide treated side](https://pubmed.ncbi.nlm.nih.gov/31585489/)
12.  [Sunscreen and prevention of skin aging: a randomized trial](https://pubmed.ncbi.nlm.nih.gov/23732711/)
13.  [Clinical evaluations showed that all photoaging parameters improved significantly from baseline as early as Week 12](https://pubmed.ncbi.nlm.nih.gov/27749441/)
14.  [The science doesn't show that any sunscreen ingredients currently available in the U.S. are harmful to human health](https://www.aad.org/media/stats-sunscreen)
15.  [Bemotrizinol is approved for use in Europe and Australasia](https://dermnetnz.org/topics/allergy-to-bemotrizinol)
16.  [There's no other sunscreen on the planet that has been tested as much as this one ingredient](https://cen.acs.org/business/consumer-products/Cloudy-outlook-sunscreen-ingredients-US/100/i42)
17.  [Bemotrizinol could secure FDA approval by the end of 2025](https://www.usatoday.com/story/news/health/2024/05/17/fda-behind-sunscreen-skin-cancer/73672619007/)
