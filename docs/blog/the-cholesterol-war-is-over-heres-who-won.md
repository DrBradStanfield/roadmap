...
All of this aligns with the low target I've personally aimed for for the past few years, based on the PESA study — which imaged the arteries of 4,184 apparently healthy, middle-aged adults with no diagnosed cardiovascular disease.
...
But the implication is powerful. Every point matters. And the old target of 70 leaves significant benefit on the table.
